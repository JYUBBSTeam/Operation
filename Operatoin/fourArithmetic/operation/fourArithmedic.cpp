...
#include<string>
#include<cmath>
#include "fourArithmedic.h"

using namespace std;


//两数的运算
FourArithmedic::FourArithmedic(string m_str1, char m_ch, string m_str2) {
...
// 比较
inline int FourArithmedic::compare(string str1, string str2) //相等返回0，大于返回1，小于返回-1
{
...
//高精度加法
string FourArithmedic::ADD_INT(string str1, string str2)
{
    int sign = 1;//sign为符号为
    string str;
    if (str1[0] == '-') {
...
//高精度减法
string FourArithmedic::SUB_INT(string str1, string str2)
{
    int sign = 1; //sign为符号位
    string str;
    int i, j;
...
//高精度乘法
string FourArithmedic::MUL_INT(string str1, string str2)
{
    int sign = 1;
    string str = "0";        //记录当前值
    if (str1[0] == '-') {
...
//高精度除法，返回商
string FourArithmedic::DIV_INT(string str1, string str2)
{
    string quotient;
    // 未完成
    return quotient;
...
// 求模，高精度除法，返回余数
string FourArithmedic::MOD_INT(string str1, string str2)
{
    string residue;  //定义余数
    int sign1 = 1, sign2 = 1;
    if (str2 == "0")   //判断除数是否为0
